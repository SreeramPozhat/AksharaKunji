...
ലിപി_നാമം = input("लिपि वालॆ फयल का नाम दीजिये (बिना .py extension): ") #Input file name of the language you desire to create
#എൻറ്റെ ഉപയോഗത്തിന് 'നാഗഗ്രന്ഥ' അല്ലെങ്കി‍ൽ 'दॆवनागरि'
